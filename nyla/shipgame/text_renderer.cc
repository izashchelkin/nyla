...
//
//   {
//     const std::vector<VkDescriptorSetLayout> descriptor_sets_layouts(kVulkan_NumFramesInFlight,
...
//     CreateMappedBuffer(per_frame->descriptor_sets[i], 0, true, sizeof(TextRendererLineUBO) *
//     std::size(submit_buffer),
...
//   memcpy(per_frame->text_line_ubo.mapped[vk.current_frame_data.iframe], &submit_buffer,
//          sizeof(TextRendererLineUBO) * isubmit);
// }
//
