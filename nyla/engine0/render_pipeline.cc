...
//                                                                  RhiMemoryUsage memoryUsage, RhiBindingType
//                                                                  bindingType, uint32_t binding, uint32_t i, bool
//                                                                  dynamic) -> void {
...
//         if (rp.dynamicUniform.enabled)
//         {
//             rp.dynamicUniform.written = AlignedUp(rp.dynamicUniform.written,
//             RhiGetMinUniformBufferOffsetAlignment());
//
//             offsetCount = 1;
