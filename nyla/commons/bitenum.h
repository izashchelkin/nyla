...
template <typename E>
constexpr std::enable_if_t<EnableBitMaskOps_v<E>, E> operator|(E lhs, E rhs) {
...
template <typename E>
constexpr std::enable_if_t<EnableBitMaskOps_v<E>, E> operator~(E val) {
  using U = std::underlying_type_t<E>;
  return static_cast<E>(~static_cast<U>(val));
}

template <typename E>
constexpr std::enable_if_t<EnableBitMaskOps_v<E>, bool> Any(E val) {
  using U = std::underlying_type_t<E>;
