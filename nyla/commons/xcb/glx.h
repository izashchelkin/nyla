...
#define XCB_GLX_GET_QUERY_OBJECTUIV_ARB 166
     ...
     */
    xcb_void_cookie_t xcb_glx_render_checked(xcb_connection_t *c, xcb_glx_context_tag_t context_tag, uint32_t data_len,
                                             const uint8_t *data);
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_render(xcb_connection_t *c, xcb_glx_context_tag_t context_tag, uint32_t data_len,
                                     const uint8_t *data);
     ...
     * saved for handling by xcb_request_check().
     */
    xcb_void_cookie_t xcb_glx_render_large_checked(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
                                                   uint16_t request_num, uint16_t request_total, uint32_t data_len,
                                                   const uint8_t *data);
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_render_large(xcb_connection_t *c, xcb_glx_context_tag_t context_tag, uint16_t request_num,
                                           uint16_t request_total, uint32_t data_len, const uint8_t *data);
     ...
     * saved for handling by xcb_request_check().
     */
    xcb_void_cookie_t xcb_glx_create_context_checked(xcb_connection_t *c, xcb_glx_context_t context,
                                                     xcb_visualid_t visual, uint32_t screen,
                                                     xcb_glx_context_t share_list, uint8_t is_direct);
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_create_context(xcb_connection_t *c, xcb_glx_context_t context, xcb_visualid_t visual,
                                             uint32_t screen, xcb_glx_context_t share_list, uint8_t is_direct);
     ...
     *
     */
    xcb_glx_query_version_cookie_t xcb_glx_query_version(xcb_connection_t *c, uint32_t major_version,
                                                         uint32_t minor_version);
     ...
     * placed in the event queue.
     */
    xcb_glx_query_version_cookie_t xcb_glx_query_version_unchecked(xcb_connection_t *c, uint32_t major_version,
                                                                   uint32_t minor_version);
     ...
     * saved for handling by xcb_request_check().
     */
    xcb_void_cookie_t xcb_glx_copy_context_checked(xcb_connection_t *c, xcb_glx_context_t src, xcb_glx_context_t dest,
                                                   uint32_t mask, xcb_glx_context_tag_t src_context_tag);
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_copy_context(xcb_connection_t *c, xcb_glx_context_t src, xcb_glx_context_t dest,
                                           uint32_t mask, xcb_glx_context_tag_t src_context_tag);
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_swap_buffers(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
                                           xcb_glx_drawable_t drawable);
     ...
     * saved for handling by xcb_request_check().
     */
    xcb_void_cookie_t xcb_glx_use_x_font_checked(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
                                                 xcb_font_t font, uint32_t first, uint32_t count, uint32_t list_base);
    ...
    xcb_void_cookie_t xcb_glx_use_x_font(xcb_connection_t *c, xcb_glx_context_tag_t context_tag, xcb_font_t font,
                                         uint32_t first, uint32_t count, uint32_t list_base);
     ...
     * saved for handling by xcb_request_check().
     */
    xcb_void_cookie_t xcb_glx_create_glx_pixmap_checked(xcb_connection_t *c, uint32_t screen, xcb_visualid_t visual,
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_create_glx_pixmap(xcb_connection_t *c, uint32_t screen, xcb_visualid_t visual,
                                                xcb_pixmap_t pixmap, xcb_glx_pixmap_t glx_pixmap);
    ...
    xcb_glx_get_visual_configs_reply_t *xcb_glx_get_visual_configs_reply(
        xcb_connection_t *c, xcb_glx_get_visual_configs_cookie_t cookie /**< */, xcb_generic_error_t **e);
     ...
     * saved for handling by xcb_request_check().
     */
    xcb_void_cookie_t xcb_glx_vendor_private_checked(xcb_connection_t *c, uint32_t vendor_code,
                                                     xcb_glx_context_tag_t context_tag, uint32_t data_len,
                                                     const uint8_t *data);
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_vendor_private(xcb_connection_t *c, uint32_t vendor_code,
                                             xcb_glx_context_tag_t context_tag, uint32_t data_len, const uint8_t *data);
    ...
    xcb_glx_vendor_private_with_reply_cookie_t xcb_glx_vendor_private_with_reply_unchecked(
        xcb_connection_t *c, uint32_t vendor_code, xcb_glx_context_tag_t context_tag, uint32_t data_len,
        const uint8_t *data);
    ...
    xcb_glx_vendor_private_with_reply_reply_t *xcb_glx_vendor_private_with_reply_reply(
        xcb_connection_t *c, xcb_glx_vendor_private_with_reply_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_glx_query_extensions_string_reply_t *xcb_glx_query_extensions_string_reply(
        xcb_connection_t *c, xcb_glx_query_extensions_string_cookie_t cookie /**< */, xcb_generic_error_t **e);
     ...
     *
     */
    xcb_glx_query_server_string_cookie_t xcb_glx_query_server_string(xcb_connection_t *c, uint32_t screen,
                                                                     uint32_t name);
     ...
     * placed in the event queue.
     */
    xcb_glx_query_server_string_cookie_t xcb_glx_query_server_string_unchecked(xcb_connection_t *c, uint32_t screen,
                                                                               uint32_t name);
    ...
    xcb_glx_query_server_string_reply_t *xcb_glx_query_server_string_reply(
        xcb_connection_t *c, xcb_glx_query_server_string_cookie_t cookie /**< */, xcb_generic_error_t **e);
     ...
     * saved for handling by xcb_request_check().
     */
    xcb_void_cookie_t xcb_glx_client_info_checked(xcb_connection_t *c, uint32_t major_version, uint32_t minor_version,
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_client_info(xcb_connection_t *c, uint32_t major_version, uint32_t minor_version,
                                          uint32_t str_len, const char *string);
     ...
     * saved for handling by xcb_request_check().
     */
    xcb_void_cookie_t xcb_glx_create_pixmap_checked(xcb_connection_t *c, uint32_t screen, xcb_glx_fbconfig_t fbconfig,
                                                    xcb_pixmap_t pixmap, xcb_glx_pixmap_t glx_pixmap,
                                                    uint32_t num_attribs, const uint32_t *attribs);
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_create_pixmap(xcb_connection_t *c, uint32_t screen, xcb_glx_fbconfig_t fbconfig,
                                            xcb_pixmap_t pixmap, xcb_glx_pixmap_t glx_pixmap, uint32_t num_attribs,
    ...
    xcb_void_cookie_t xcb_glx_create_new_context_checked(xcb_connection_t *c, xcb_glx_context_t context,
                                                         xcb_glx_fbconfig_t fbconfig, uint32_t screen,
                                                         uint32_t render_type, xcb_glx_context_t share_list,
                                                         uint8_t is_direct);
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_create_new_context(xcb_connection_t *c, xcb_glx_context_t context,
                                                 xcb_glx_fbconfig_t fbconfig, uint32_t screen, uint32_t render_type,
                                                 xcb_glx_context_t share_list, uint8_t is_direct);
    ...
    xcb_glx_make_context_current_reply_t *xcb_glx_make_context_current_reply(
        xcb_connection_t *c, xcb_glx_make_context_current_cookie_t cookie /**< */, xcb_generic_error_t **e);
     ...
     * saved for handling by xcb_request_check().
     */
    xcb_void_cookie_t xcb_glx_create_pbuffer_checked(xcb_connection_t *c, uint32_t screen, xcb_glx_fbconfig_t fbconfig,
                                                     xcb_glx_pbuffer_t pbuffer, uint32_t num_attribs,
                                                     const uint32_t *attribs);
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_create_pbuffer(xcb_connection_t *c, uint32_t screen, xcb_glx_fbconfig_t fbconfig,
                                             xcb_glx_pbuffer_t pbuffer, uint32_t num_attribs, const uint32_t *attribs);
    ...
    xcb_glx_get_drawable_attributes_reply_t *xcb_glx_get_drawable_attributes_reply(
        xcb_connection_t *c, xcb_glx_get_drawable_attributes_cookie_t cookie /**< */, xcb_generic_error_t **e);
     ...
     * saved for handling by xcb_request_check().
     */
    xcb_void_cookie_t xcb_glx_create_window_checked(xcb_connection_t *c, uint32_t screen, xcb_glx_fbconfig_t fbconfig,
                                                    xcb_window_t window, xcb_glx_window_t glx_window,
                                                    uint32_t num_attribs, const uint32_t *attribs);
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_create_window(xcb_connection_t *c, uint32_t screen, xcb_glx_fbconfig_t fbconfig,
                                            xcb_window_t window, xcb_glx_window_t glx_window, uint32_t num_attribs,
                                            const uint32_t *attribs);
     ...
     * saved for handling by xcb_request_check().
     */
    xcb_void_cookie_t xcb_glx_set_client_info_arb_checked(xcb_connection_t *c, uint32_t major_version,
                                                          uint32_t minor_version, uint32_t num_versions,
                                                          uint32_t gl_str_len, uint32_t glx_str_len,
                                                          const uint32_t *gl_versions, const char *gl_extension_string,
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_set_client_info_arb(xcb_connection_t *c, uint32_t major_version, uint32_t minor_version,
                                                  uint32_t num_versions, uint32_t gl_str_len, uint32_t glx_str_len,
                                                  const uint32_t *gl_versions, const char *gl_extension_string,
                                                  const char *glx_extension_string);
     ...
     * saved for handling by xcb_request_check().
     */
    xcb_void_cookie_t xcb_glx_set_client_info_2arb_checked(xcb_connection_t *c, uint32_t major_version,
                                                           uint32_t minor_version, uint32_t num_versions,
                                                           uint32_t gl_str_len, uint32_t glx_str_len,
                                                           const uint32_t *gl_versions, const char *gl_extension_string,
                                                           const char *glx_extension_string);
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_set_client_info_2arb(xcb_connection_t *c, uint32_t major_version, uint32_t minor_version,
                                                   uint32_t num_versions, uint32_t gl_str_len, uint32_t glx_str_len,
                                                   const uint32_t *gl_versions, const char *gl_extension_string,
                                                   const char *glx_extension_string);
     ...
     * saved for handling by xcb_request_check().
     */
    xcb_void_cookie_t xcb_glx_new_list_checked(xcb_connection_t *c, xcb_glx_context_tag_t context_tag, uint32_t list,
                                               uint32_t mode);
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_new_list(xcb_connection_t *c, xcb_glx_context_tag_t context_tag, uint32_t list,
                                       uint32_t mode);
     ...
     * saved for handling by xcb_request_check().
     */
    xcb_void_cookie_t xcb_glx_delete_lists_checked(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_delete_lists(xcb_connection_t *c, xcb_glx_context_tag_t context_tag, uint32_t list,
                                           int32_t range);
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_feedback_buffer(xcb_connection_t *c, xcb_glx_context_tag_t context_tag, int32_t size,
                                              int32_t type);
     ...
     * saved for handling by xcb_request_check().
     */
    xcb_void_cookie_t xcb_glx_select_buffer_checked(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
                                                    int32_t size);
     ...
     * The returned value must be freed by the caller using free().
     */
    xcb_glx_finish_reply_t *xcb_glx_finish_reply(xcb_connection_t *c, xcb_glx_finish_cookie_t cookie /**< */,
                                                 xcb_generic_error_t **e);
     ...
     * saved for handling by xcb_request_check().
     */
    xcb_void_cookie_t xcb_glx_pixel_storef_checked(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
                                                   uint32_t pname, xcb_glx_float32_t datum);
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_pixel_storef(xcb_connection_t *c, xcb_glx_context_tag_t context_tag, uint32_t pname,
                                           xcb_glx_float32_t datum);
     ...
     * saved for handling by xcb_request_check().
     */
    xcb_void_cookie_t xcb_glx_pixel_storei_checked(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
                                                   uint32_t pname, int32_t datum);
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_pixel_storei(xcb_connection_t *c, xcb_glx_context_tag_t context_tag, uint32_t pname,
                                           int32_t datum);
     ...
     *
     */
    xcb_glx_read_pixels_cookie_t xcb_glx_read_pixels(xcb_connection_t *c, xcb_glx_context_tag_t context_tag, int32_t x,
                                                     int32_t y, int32_t width, int32_t height, uint32_t format,
                                                     uint32_t type, uint8_t swap_bytes, uint8_t lsb_first);
     ...
     * placed in the event queue.
     */
    xcb_glx_read_pixels_cookie_t xcb_glx_read_pixels_unchecked(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
                                                               int32_t x, int32_t y, int32_t width, int32_t height,
                                                               uint32_t format, uint32_t type, uint8_t swap_bytes,
                                                               uint8_t lsb_first);
    ...
    xcb_glx_get_clip_plane_cookie_t xcb_glx_get_clip_plane_unchecked(xcb_connection_t *c,
                                                                     xcb_glx_context_tag_t context_tag, int32_t plane);
     ...
     *
     */
    xcb_glx_get_floatv_cookie_t xcb_glx_get_floatv(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
                                                   uint32_t pname);
     ...
     * placed in the event queue.
     */
    xcb_glx_get_lightfv_cookie_t xcb_glx_get_lightfv_unchecked(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
                                                               uint32_t light, uint32_t pname);
     ...
     * placed in the event queue.
     */
    xcb_glx_get_lightiv_cookie_t xcb_glx_get_lightiv_unchecked(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
                                                               uint32_t light, uint32_t pname);
     ...
     *
     */
    xcb_glx_get_mapdv_cookie_t xcb_glx_get_mapdv(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
     ...
     *
     */
    xcb_glx_get_mapfv_cookie_t xcb_glx_get_mapfv(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
                                                 uint32_t target, uint32_t query);
     ...
     *
     */
    xcb_glx_get_mapiv_cookie_t xcb_glx_get_mapiv(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
                                                 uint32_t target, uint32_t query);
    ...
    xcb_glx_get_materialfv_cookie_t xcb_glx_get_materialfv_unchecked(xcb_connection_t *c,
                                                                     xcb_glx_context_tag_t context_tag, uint32_t face,
                                                                     uint32_t pname);
    ...
    xcb_glx_get_pixel_mapfv_cookie_t xcb_glx_get_pixel_mapfv_unchecked(xcb_connection_t *c,
                                                                       xcb_glx_context_tag_t context_tag, uint32_t map);
    ...
    xcb_glx_get_polygon_stipple_reply_t *xcb_glx_get_polygon_stipple_reply(
        xcb_connection_t *c, xcb_glx_get_polygon_stipple_cookie_t cookie /**< */, xcb_generic_error_t **e);
     ...
     *
     */
    xcb_glx_get_string_cookie_t xcb_glx_get_string(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
                                                   uint32_t name);
    ...
    xcb_glx_get_tex_envfv_cookie_t xcb_glx_get_tex_envfv_unchecked(xcb_connection_t *c,
                                                                   xcb_glx_context_tag_t context_tag, uint32_t target,
                                                                   uint32_t pname);
    ...
    xcb_glx_get_tex_gendv_cookie_t xcb_glx_get_tex_gendv_unchecked(xcb_connection_t *c,
                                                                   xcb_glx_context_tag_t context_tag, uint32_t coord,
                                                                   uint32_t pname);
     ...
     *
     */
    xcb_glx_get_tex_image_cookie_t xcb_glx_get_tex_image(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
    ...
    xcb_glx_get_tex_image_cookie_t xcb_glx_get_tex_image_unchecked(xcb_connection_t *c,
                                                                   xcb_glx_context_tag_t context_tag, uint32_t target,
                                                                   int32_t level, uint32_t format, uint32_t type,
                                                                   uint8_t swap_bytes);
    ...
    xcb_glx_get_tex_parameterfv_reply_t *xcb_glx_get_tex_parameterfv_reply(
        xcb_connection_t *c, xcb_glx_get_tex_parameterfv_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_glx_get_tex_parameteriv_reply_t *xcb_glx_get_tex_parameteriv_reply(
        xcb_connection_t *c, xcb_glx_get_tex_parameteriv_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_glx_get_tex_level_parameterfv_cookie_t xcb_glx_get_tex_level_parameterfv_unchecked(
        xcb_connection_t *c, xcb_glx_context_tag_t context_tag, uint32_t target, int32_t level, uint32_t pname);
    ...
    xcb_glx_get_tex_level_parameterfv_reply_t *xcb_glx_get_tex_level_parameterfv_reply(
        xcb_connection_t *c, xcb_glx_get_tex_level_parameterfv_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_glx_get_tex_level_parameteriv_reply_t *xcb_glx_get_tex_level_parameteriv_reply(
        xcb_connection_t *c, xcb_glx_get_tex_level_parameteriv_cookie_t cookie /**< */, xcb_generic_error_t **e);
     ...
     *
     */
    xcb_glx_is_enabled_cookie_t xcb_glx_is_enabled(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
                                                   uint32_t capability);
     ...
     * placed in the event queue.
     */
    xcb_glx_is_enabled_cookie_t xcb_glx_is_enabled_unchecked(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
                                                             uint32_t capability);
    ...
    xcb_glx_are_textures_resident_cookie_t xcb_glx_are_textures_resident(xcb_connection_t *c,
                                                                         xcb_glx_context_tag_t context_tag, int32_t n,
    ...
    xcb_glx_are_textures_resident_cookie_t xcb_glx_are_textures_resident_unchecked(xcb_connection_t *c,
                                                                                   xcb_glx_context_tag_t context_tag,
                                                                                   int32_t n, const uint32_t *textures);
    ...
    xcb_glx_are_textures_resident_reply_t *xcb_glx_are_textures_resident_reply(
        xcb_connection_t *c, xcb_glx_are_textures_resident_cookie_t cookie /**< */, xcb_generic_error_t **e);
     ...
     * saved for handling by xcb_request_check().
     */
    xcb_void_cookie_t xcb_glx_delete_textures_checked(xcb_connection_t *c, xcb_glx_context_tag_t context_tag, int32_t n,
                                                      const uint32_t *textures);
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_delete_textures(xcb_connection_t *c, xcb_glx_context_tag_t context_tag, int32_t n,
                                              const uint32_t *textures);
     ...
     *
     */
    xcb_glx_is_texture_cookie_t xcb_glx_is_texture(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
                                                   uint32_t texture);
    ...
    xcb_glx_get_color_table_cookie_t xcb_glx_get_color_table(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
                                                             uint32_t target, uint32_t format, uint32_t type,
                                                             uint8_t swap_bytes);
    ...
    xcb_glx_get_color_table_parameterfv_cookie_t xcb_glx_get_color_table_parameterfv_unchecked(
        xcb_connection_t *c, xcb_glx_context_tag_t context_tag, uint32_t target, uint32_t pname);
    ...
    xcb_glx_get_color_table_parameterfv_reply_t *xcb_glx_get_color_table_parameterfv_reply(
        xcb_connection_t *c, xcb_glx_get_color_table_parameterfv_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_glx_get_color_table_parameteriv_reply_t *xcb_glx_get_color_table_parameteriv_reply(
        xcb_connection_t *c, xcb_glx_get_color_table_parameteriv_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_glx_get_convolution_filter_cookie_t xcb_glx_get_convolution_filter(xcb_connection_t *c,
                                                                           ...
                                                                           uint32_t type, uint8_t swap_bytes);
    ...
    xcb_glx_get_convolution_filter_reply_t *xcb_glx_get_convolution_filter_reply(
        xcb_connection_t *c, xcb_glx_get_convolution_filter_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_glx_get_convolution_parameterfv_reply_t *xcb_glx_get_convolution_parameterfv_reply(
        xcb_connection_t *c, xcb_glx_get_convolution_parameterfv_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_glx_get_convolution_parameteriv_reply_t *xcb_glx_get_convolution_parameteriv_reply(
        xcb_connection_t *c, xcb_glx_get_convolution_parameteriv_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_glx_get_separable_filter_reply_t *xcb_glx_get_separable_filter_reply(
        xcb_connection_t *c, xcb_glx_get_separable_filter_cookie_t cookie /**< */, xcb_generic_error_t **e);
     ...
     *
     */
    xcb_glx_get_histogram_cookie_t xcb_glx_get_histogram(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
                                                         uint32_t target, uint32_t format, uint32_t type,
                                                         uint8_t swap_bytes, uint8_t reset);
    ...
    xcb_glx_get_histogram_parameterfv_reply_t *xcb_glx_get_histogram_parameterfv_reply(
        xcb_connection_t *c, xcb_glx_get_histogram_parameterfv_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_glx_get_histogram_parameteriv_reply_t *xcb_glx_get_histogram_parameteriv_reply(
        xcb_connection_t *c, xcb_glx_get_histogram_parameteriv_cookie_t cookie /**< */, xcb_generic_error_t **e);
     ...
     *
     */
    xcb_glx_get_minmax_cookie_t xcb_glx_get_minmax(xcb_connection_t *c, xcb_glx_context_tag_t context_tag,
                                                   uint32_t target, uint32_t format, uint32_t type, uint8_t swap_bytes,
                                                   uint8_t reset);
    ...
    xcb_glx_get_minmax_parameterfv_reply_t *xcb_glx_get_minmax_parameterfv_reply(
        xcb_connection_t *c, xcb_glx_get_minmax_parameterfv_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_glx_get_minmax_parameteriv_reply_t *xcb_glx_get_minmax_parameteriv_reply(
        xcb_connection_t *c, xcb_glx_get_minmax_parameteriv_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_glx_get_compressed_tex_image_arb_cookie_t xcb_glx_get_compressed_tex_image_arb(
        xcb_connection_t *c, xcb_glx_context_tag_t context_tag, uint32_t target, int32_t level);
    ...
    xcb_glx_get_compressed_tex_image_arb_reply_t *xcb_glx_get_compressed_tex_image_arb_reply(
        xcb_connection_t *c, xcb_glx_get_compressed_tex_image_arb_cookie_t cookie /**< */, xcb_generic_error_t **e);
     ...
     *
     */
    xcb_void_cookie_t xcb_glx_delete_queries_arb(xcb_connection_t *c, xcb_glx_context_tag_t context_tag, int32_t n,
                                                 const uint32_t *ids);
    ...
    xcb_glx_get_query_objectiv_arb_reply_t *xcb_glx_get_query_objectiv_arb_reply(
        xcb_connection_t *c, xcb_glx_get_query_objectiv_arb_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_glx_get_query_objectuiv_arb_cookie_t xcb_glx_get_query_objectuiv_arb_unchecked(
        xcb_connection_t *c, xcb_glx_context_tag_t context_tag, uint32_t id, uint32_t pname);
    ...
    xcb_glx_get_query_objectuiv_arb_reply_t *xcb_glx_get_query_objectuiv_arb_reply(
        xcb_connection_t *c, xcb_glx_get_query_objectuiv_arb_cookie_t cookie /**< */, xcb_generic_error_t **e);
