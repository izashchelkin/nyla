...
#define XCB_DRI2_INVALIDATE_BUFFERS 1
     ...
     *
     */
    xcb_dri2_query_version_cookie_t xcb_dri2_query_version(xcb_connection_t *c, uint32_t major_version,
                                                           uint32_t minor_version);
     ...
     */
    xcb_dri2_query_version_cookie_t xcb_dri2_query_version_unchecked(xcb_connection_t *c, uint32_t major_version,
                                                                     uint32_t minor_version);
     ...
     * placed in the event queue.
     */
    xcb_dri2_connect_cookie_t xcb_dri2_connect_unchecked(xcb_connection_t *c, xcb_window_t window,
                                                         uint32_t driver_type);
     ...
     *
     */
    xcb_dri2_get_buffers_cookie_t xcb_dri2_get_buffers(xcb_connection_t *c, xcb_drawable_t drawable, uint32_t count,
                                                       uint32_t attachments_len, const uint32_t *attachments);
     ...
     * placed in the event queue.
     */
    xcb_dri2_get_buffers_cookie_t xcb_dri2_get_buffers_unchecked(xcb_connection_t *c, xcb_drawable_t drawable,
     ...
     *
     */
    xcb_dri2_copy_region_cookie_t xcb_dri2_copy_region(xcb_connection_t *c, xcb_drawable_t drawable, uint32_t region,
    ...
    xcb_dri2_copy_region_cookie_t xcb_dri2_copy_region_unchecked(xcb_connection_t *c, xcb_drawable_t drawable,
                                                                 uint32_t region, uint32_t dest, uint32_t src);
    ...
    int xcb_dri2_get_buffers_with_format_sizeof(const void *_buffer, uint32_t attachments_len);
    ...
    xcb_dri2_get_buffers_with_format_cookie_t xcb_dri2_get_buffers_with_format(
        xcb_connection_t *c, xcb_drawable_t drawable, uint32_t count, uint32_t attachments_len,
    ...
    xcb_dri2_get_buffers_with_format_reply_t *xcb_dri2_get_buffers_with_format_reply(
        xcb_connection_t *c, xcb_dri2_get_buffers_with_format_cookie_t cookie /**< */, xcb_generic_error_t **e);
     ...
     *
     */
    xcb_dri2_swap_buffers_cookie_t xcb_dri2_swap_buffers(xcb_connection_t *c, xcb_drawable_t drawable,
     ...
     *
     */
    xcb_dri2_wait_msc_cookie_t xcb_dri2_wait_msc(xcb_connection_t *c, xcb_drawable_t drawable, uint32_t target_msc_hi,
                                                 uint32_t target_msc_lo, uint32_t divisor_hi, uint32_t divisor_lo,
                                                 uint32_t remainder_hi, uint32_t remainder_lo);
     ...
     * placed in the event queue.
     */
    xcb_dri2_wait_msc_cookie_t xcb_dri2_wait_msc_unchecked(xcb_connection_t *c, xcb_drawable_t drawable,
                                                           uint32_t target_msc_hi, uint32_t target_msc_lo,
                                                           uint32_t divisor_hi, uint32_t divisor_lo,
                                                           uint32_t remainder_hi, uint32_t remainder_lo);
     ...
     *
     */
    xcb_dri2_wait_sbc_cookie_t xcb_dri2_wait_sbc(xcb_connection_t *c, xcb_drawable_t drawable, uint32_t target_sbc_hi,
                                                 uint32_t target_sbc_lo);
    ...
    xcb_dri2_wait_sbc_cookie_t xcb_dri2_wait_sbc_unchecked(xcb_connection_t *c, xcb_drawable_t drawable,
                                                           uint32_t target_sbc_hi, uint32_t target_sbc_lo);
     ...
     * placed in the event queue.
     */
    xcb_dri2_get_param_cookie_t xcb_dri2_get_param_unchecked(xcb_connection_t *c, xcb_drawable_t drawable,
                                                             uint32_t param);
