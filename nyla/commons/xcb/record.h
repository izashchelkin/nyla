...
#define XCB_RECORD_FREE_CONTEXT 7
     ...
     *
     */
    xcb_record_query_version_cookie_t xcb_record_query_version(xcb_connection_t *c, uint16_t major_version,
                                                               uint16_t minor_version);
     ...
     */
    xcb_record_query_version_cookie_t xcb_record_query_version_unchecked(xcb_connection_t *c, uint16_t major_version,
                                                                         uint16_t minor_version);
    ...
    xcb_void_cookie_t xcb_record_create_context_checked(xcb_connection_t *c, xcb_record_context_t context,
                                                        xcb_record_element_header_t element_header,
                                                        uint32_t num_client_specs, uint32_t num_ranges,
    ...
    xcb_void_cookie_t xcb_record_create_context(xcb_connection_t *c, xcb_record_context_t context,
                                                xcb_record_element_header_t element_header, uint32_t num_client_specs,
                                                uint32_t num_ranges, const xcb_record_client_spec_t *client_specs,
                                                const xcb_record_range_t *ranges);
    ...
    xcb_record_range_t *xcb_record_create_context_ranges(const xcb_record_create_context_request_t *R);
    ...
    xcb_record_range_t *xcb_record_register_clients_ranges(const xcb_record_register_clients_request_t *R);
     ...
     *
     */
    xcb_void_cookie_t xcb_record_unregister_clients(xcb_connection_t *c, xcb_record_context_t context,
                                                    uint32_t num_client_specs,
                                                    const xcb_record_client_spec_t *client_specs);
    ...
    xcb_record_enable_context_reply_t *xcb_record_enable_context_reply(
        xcb_connection_t *c, xcb_record_enable_context_cookie_t cookie /**< */, xcb_generic_error_t **e);
