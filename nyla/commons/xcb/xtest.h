...
#define XCB_TEST_GRAB_CONTROL 3
     ...
     *
     */
    xcb_test_get_version_cookie_t xcb_test_get_version(xcb_connection_t *c, uint8_t major_version,
                                                       uint16_t minor_version);
     ...
     */
    xcb_test_get_version_cookie_t xcb_test_get_version_unchecked(xcb_connection_t *c, uint8_t major_version,
                                                                 uint16_t minor_version);
     ...
     *
     */
    xcb_test_compare_cursor_cookie_t xcb_test_compare_cursor(xcb_connection_t *c, xcb_window_t window,
                                                             xcb_cursor_t cursor);
     ...
     */
    xcb_void_cookie_t xcb_test_fake_input_checked(xcb_connection_t *c, uint8_t type, uint8_t detail, uint32_t time,
                                                  xcb_window_t root, int16_t rootX, int16_t rootY, uint8_t deviceid);
     ...
     *
     */
    xcb_void_cookie_t xcb_test_fake_input(xcb_connection_t *c, uint8_t type, uint8_t detail, uint32_t time,
                                          xcb_window_t root, int16_t rootX, int16_t rootY, uint8_t deviceid);
