...
#define XCB_XV_SHM_PUT_IMAGE 19
    ...
    xcb_void_cookie_t xcb_xv_put_video_checked(xcb_connection_t *c, xcb_xv_port_t port, xcb_drawable_t drawable,
                                               xcb_gcontext_t gc, int16_t vid_x, int16_t vid_y, uint16_t vid_w,
                                               uint16_t vid_h, int16_t drw_x, int16_t drw_y, uint16_t drw_w,
                                               uint16_t drw_h);
     ...
     *
     */
    xcb_void_cookie_t xcb_xv_put_video(xcb_connection_t *c, xcb_xv_port_t port, xcb_drawable_t drawable,
                                       xcb_gcontext_t gc, int16_t vid_x, int16_t vid_y, uint16_t vid_w, uint16_t vid_h,
                                       int16_t drw_x, int16_t drw_y, uint16_t drw_w, uint16_t drw_h);
     ...
     *
     */
    xcb_void_cookie_t xcb_xv_put_still(xcb_connection_t *c, xcb_xv_port_t port, xcb_drawable_t drawable,
                                       xcb_gcontext_t gc, int16_t vid_x, int16_t vid_y, uint16_t vid_w, uint16_t vid_h,
                                       int16_t drw_x, int16_t drw_y, uint16_t drw_w, uint16_t drw_h);
     ...
     *
     */
    xcb_void_cookie_t xcb_xv_get_video(xcb_connection_t *c, xcb_xv_port_t port, xcb_drawable_t drawable,
                                       xcb_gcontext_t gc, int16_t vid_x, int16_t vid_y, uint16_t vid_w, uint16_t vid_h,
                                       int16_t drw_x, int16_t drw_y, uint16_t drw_w, uint16_t drw_h);
     ...
     *
     */
    xcb_void_cookie_t xcb_xv_get_still(xcb_connection_t *c, xcb_xv_port_t port, xcb_drawable_t drawable,
                                       xcb_gcontext_t gc, int16_t vid_x, int16_t vid_y, uint16_t vid_w, uint16_t vid_h,
                                       int16_t drw_x, int16_t drw_y, uint16_t drw_w, uint16_t drw_h);
     ...
     *
     */
    xcb_xv_query_best_size_cookie_t xcb_xv_query_best_size(xcb_connection_t *c, xcb_xv_port_t port, uint16_t vid_w,
                                                           uint16_t vid_h, uint16_t drw_w, uint16_t drw_h,
                                                           uint8_t motion);
     ...
     * placed in the event queue.
     */
    xcb_xv_query_best_size_cookie_t xcb_xv_query_best_size_unchecked(xcb_connection_t *c, xcb_xv_port_t port,
                                                                     uint16_t vid_w, uint16_t vid_h, uint16_t drw_w,
                                                                     uint16_t drw_h, uint8_t motion);
     ...
     *
     */
    xcb_xv_get_port_attribute_cookie_t xcb_xv_get_port_attribute(xcb_connection_t *c, xcb_xv_port_t port,
                                                                 xcb_atom_t attribute);
    ...
    xcb_xv_get_port_attribute_reply_t *xcb_xv_get_port_attribute_reply(
        xcb_connection_t *c, xcb_xv_get_port_attribute_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_xv_query_port_attributes_reply_t *xcb_xv_query_port_attributes_reply(
        xcb_connection_t *c, xcb_xv_query_port_attributes_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_xv_list_image_formats_reply_t *xcb_xv_list_image_formats_reply(
        xcb_connection_t *c, xcb_xv_list_image_formats_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_xv_query_image_attributes_cookie_t xcb_xv_query_image_attributes_unchecked(xcb_connection_t *c,
                                                                                   xcb_xv_port_t port, uint32_t id,
    ...
    xcb_xv_query_image_attributes_reply_t *xcb_xv_query_image_attributes_reply(
        xcb_connection_t *c, xcb_xv_query_image_attributes_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_void_cookie_t xcb_xv_put_image_checked(xcb_connection_t *c, xcb_xv_port_t port, xcb_drawable_t drawable,
                                               xcb_gcontext_t gc, uint32_t id, int16_t src_x, int16_t src_y,
                                               uint16_t src_w, uint16_t src_h, int16_t drw_x, int16_t drw_y,
                                               uint16_t drw_w, uint16_t drw_h, uint16_t width, uint16_t height,
     ...
     *
     */
    xcb_void_cookie_t xcb_xv_put_image(xcb_connection_t *c, xcb_xv_port_t port, xcb_drawable_t drawable,
                                       xcb_gcontext_t gc, uint32_t id, int16_t src_x, int16_t src_y, uint16_t src_w,
                                       uint16_t src_h, int16_t drw_x, int16_t drw_y, uint16_t drw_w, uint16_t drw_h,
                                       uint16_t width, uint16_t height, uint32_t data_len, const uint8_t *data);
    ...
    xcb_void_cookie_t xcb_xv_shm_put_image_checked(xcb_connection_t *c, xcb_xv_port_t port, xcb_drawable_t drawable,
                                                   xcb_gcontext_t gc, xcb_shm_seg_t shmseg, uint32_t id,
                                                   uint32_t offset, int16_t src_x, int16_t src_y, uint16_t src_w,
                                                   uint16_t src_h, int16_t drw_x, int16_t drw_y, uint16_t drw_w,
                                                   uint16_t drw_h, uint16_t width, uint16_t height, uint8_t send_event);
     ...
     *
     */
    xcb_void_cookie_t xcb_xv_shm_put_image(xcb_connection_t *c, xcb_xv_port_t port, xcb_drawable_t drawable,
                                           xcb_gcontext_t gc, xcb_shm_seg_t shmseg, uint32_t id, uint32_t offset,
                                           int16_t src_x, int16_t src_y, uint16_t src_w, uint16_t src_h, int16_t drw_x,
                                           int16_t drw_y, uint16_t drw_w, uint16_t drw_h, uint16_t width,
                                           uint16_t height, uint8_t send_event);
