...
#define XCB_XVMC_LIST_SUBPICTURE_TYPES 8
    ...
    xcb_xvmc_list_surface_types_reply_t *xcb_xvmc_list_surface_types_reply(
        xcb_connection_t *c, xcb_xvmc_list_surface_types_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_xvmc_create_context_cookie_t xcb_xvmc_create_context(xcb_connection_t *c, xcb_xvmc_context_t context_id,
                                                             xcb_xv_port_t port_id, xcb_xvmc_surface_t surface_id,
    ...
    xcb_xvmc_create_context_cookie_t xcb_xvmc_create_context_unchecked(xcb_connection_t *c,
                                                                       xcb_xvmc_context_t context_id,
                                                                       xcb_xv_port_t port_id,
                                                                       xcb_xvmc_surface_t surface_id, uint16_t width,
     ...
     *
     */
    xcb_xvmc_create_surface_cookie_t xcb_xvmc_create_surface(xcb_connection_t *c, xcb_xvmc_surface_t surface_id,
                                                             xcb_xvmc_context_t context_id);
    ...
    xcb_xvmc_create_subpicture_cookie_t xcb_xvmc_create_subpicture(xcb_connection_t *c,
                                                                   xcb_xvmc_subpicture_t subpicture_id,
                                                                   xcb_xvmc_context_t context, uint32_t xvimage_id,
    ...
    xcb_xvmc_create_subpicture_cookie_t xcb_xvmc_create_subpicture_unchecked(xcb_connection_t *c,
                                                                             xcb_xvmc_subpicture_t subpicture_id,
                                                                             xcb_xvmc_context_t context,
                                                                             uint32_t xvimage_id, uint16_t width,
                                                                             uint16_t height);
    ...
    xcb_xvmc_create_subpicture_reply_t *xcb_xvmc_create_subpicture_reply(
        xcb_connection_t *c, xcb_xvmc_create_subpicture_cookie_t cookie /**< */, xcb_generic_error_t **e);
     ...
     *
     */
    xcb_xvmc_list_subpicture_types_cookie_t xcb_xvmc_list_subpicture_types(xcb_connection_t *c, xcb_xv_port_t port_id,
                                                                           xcb_xvmc_surface_t surface_id);
    ...
    xcb_xvmc_list_subpicture_types_reply_t *xcb_xvmc_list_subpicture_types_reply(
        xcb_connection_t *c, xcb_xvmc_list_subpicture_types_cookie_t cookie /**< */, xcb_generic_error_t **e);
