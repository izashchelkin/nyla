...
#define XCB_XF86DRI_AUTH_CONNECTION 11
    ...
    xcb_xf86dri_query_version_reply_t *xcb_xf86dri_query_version_reply(
        xcb_connection_t *c, xcb_xf86dri_query_version_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_xf86dri_query_direct_rendering_capable_cookie_t xcb_xf86dri_query_direct_rendering_capable_unchecked(
        xcb_connection_t *c, uint32_t screen);
    ...
    xcb_xf86dri_query_direct_rendering_capable_reply_t *xcb_xf86dri_query_direct_rendering_capable_reply(
        xcb_connection_t *c, xcb_xf86dri_query_direct_rendering_capable_cookie_t cookie /**< */,
    ...
    xcb_xf86dri_open_connection_reply_t *xcb_xf86dri_open_connection_reply(
        xcb_connection_t *c, xcb_xf86dri_open_connection_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_xf86dri_get_client_driver_name_reply_t *xcb_xf86dri_get_client_driver_name_reply(
        xcb_connection_t *c, xcb_xf86dri_get_client_driver_name_cookie_t cookie /**< */, xcb_generic_error_t **e);
     ...
     *
     */
    xcb_xf86dri_create_context_cookie_t xcb_xf86dri_create_context(xcb_connection_t *c, uint32_t screen,
                                                                   uint32_t visual, uint32_t context);
     ...
     * placed in the event queue.
     */
    xcb_xf86dri_create_context_cookie_t xcb_xf86dri_create_context_unchecked(xcb_connection_t *c, uint32_t screen,
                                                                             uint32_t visual, uint32_t context);
    ...
    xcb_xf86dri_create_context_reply_t *xcb_xf86dri_create_context_reply(
        xcb_connection_t *c, xcb_xf86dri_create_context_cookie_t cookie /**< */, xcb_generic_error_t **e);
     ...
     *
     */
    xcb_xf86dri_create_drawable_cookie_t xcb_xf86dri_create_drawable(xcb_connection_t *c, uint32_t screen,
                                                                     uint32_t drawable);
     ...
     * placed in the event queue.
     */
    xcb_xf86dri_create_drawable_cookie_t xcb_xf86dri_create_drawable_unchecked(xcb_connection_t *c, uint32_t screen,
                                                                               uint32_t drawable);
    ...
    xcb_xf86dri_create_drawable_reply_t *xcb_xf86dri_create_drawable_reply(
        xcb_connection_t *c, xcb_xf86dri_create_drawable_cookie_t cookie /**< */, xcb_generic_error_t **e);
     ...
     *
     */
    xcb_xf86dri_get_drawable_info_cookie_t xcb_xf86dri_get_drawable_info(xcb_connection_t *c, uint32_t screen,
                                                                         uint32_t drawable);
     ...
     * placed in the event queue.
     */
    xcb_xf86dri_get_drawable_info_cookie_t xcb_xf86dri_get_drawable_info_unchecked(xcb_connection_t *c, uint32_t screen,
                                                                                   uint32_t drawable);
    ...
    xcb_xf86dri_get_drawable_info_reply_t *xcb_xf86dri_get_drawable_info_reply(
        xcb_connection_t *c, xcb_xf86dri_get_drawable_info_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_xf86dri_get_device_info_reply_t *xcb_xf86dri_get_device_info_reply(
        xcb_connection_t *c, xcb_xf86dri_get_device_info_cookie_t cookie /**< */, xcb_generic_error_t **e);
     ...
     *
     */
    xcb_xf86dri_auth_connection_cookie_t xcb_xf86dri_auth_connection(xcb_connection_t *c, uint32_t screen,
                                                                     uint32_t magic);
     ...
     * placed in the event queue.
     */
    xcb_xf86dri_auth_connection_cookie_t xcb_xf86dri_auth_connection_unchecked(xcb_connection_t *c, uint32_t screen,
                                                                               uint32_t magic);
    ...
    xcb_xf86dri_auth_connection_reply_t *xcb_xf86dri_auth_connection_reply(
        xcb_connection_t *c, xcb_xf86dri_auth_connection_cookie_t cookie /**< */, xcb_generic_error_t **e);
