...
#define XCB_DPMS_INFO_NOTIFY 0
     ...
     *
     */
    xcb_dpms_get_version_cookie_t xcb_dpms_get_version(xcb_connection_t *c, uint16_t client_major_version,
                                                       uint16_t client_minor_version);
     ...
     */
    xcb_dpms_get_version_cookie_t xcb_dpms_get_version_unchecked(xcb_connection_t *c, uint16_t client_major_version,
                                                                 uint16_t client_minor_version);
     ...
     */
    xcb_void_cookie_t xcb_dpms_set_timeouts_checked(xcb_connection_t *c, uint16_t standby_timeout,
                                                    uint16_t suspend_timeout, uint16_t off_timeout);
     ...
     *
     */
    xcb_void_cookie_t xcb_dpms_set_timeouts(xcb_connection_t *c, uint16_t standby_timeout, uint16_t suspend_timeout,
                                            uint16_t off_timeout);
     ...
     * The returned value must be freed by the caller using free().
     */
    xcb_dpms_info_reply_t *xcb_dpms_info_reply(xcb_connection_t *c, xcb_dpms_info_cookie_t cookie /**< */,
                                               xcb_generic_error_t **e);
