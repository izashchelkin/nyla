...
#define XCB_RES_QUERY_RESOURCE_BYTES 5
     ...
     */
    xcb_res_query_version_cookie_t xcb_res_query_version_unchecked(xcb_connection_t *c, uint8_t client_major,
                                                                   uint8_t client_minor);
    ...
    xcb_res_query_client_resources_reply_t *xcb_res_query_client_resources_reply(
        xcb_connection_t *c, xcb_res_query_client_resources_cookie_t cookie /**< */, xcb_generic_error_t **e);
    ...
    xcb_res_query_client_pixmap_bytes_reply_t *xcb_res_query_client_pixmap_bytes_reply(
        xcb_connection_t *c, xcb_res_query_client_pixmap_bytes_cookie_t cookie /**< */, xcb_generic_error_t **e);
     ...
     *
     */
    xcb_res_query_client_ids_cookie_t xcb_res_query_client_ids(xcb_connection_t *c, uint32_t num_specs,
     ...
     * placed in the event queue.
     */
    xcb_res_query_client_ids_cookie_t xcb_res_query_client_ids_unchecked(xcb_connection_t *c, uint32_t num_specs,
                                                                         const xcb_res_client_id_spec_t *specs);
     ...
     *
     */
    xcb_res_query_resource_bytes_cookie_t xcb_res_query_resource_bytes(xcb_connection_t *c, uint32_t client,
                                                                       uint32_t num_specs,
    ...
    xcb_res_query_resource_bytes_cookie_t xcb_res_query_resource_bytes_unchecked(
        xcb_connection_t *c, uint32_t client, uint32_t num_specs, const xcb_res_resource_id_spec_t *specs);
    ...
    xcb_res_query_resource_bytes_reply_t *xcb_res_query_resource_bytes_reply(
        xcb_connection_t *c, xcb_res_query_resource_bytes_cookie_t cookie /**< */, xcb_generic_error_t **e);
