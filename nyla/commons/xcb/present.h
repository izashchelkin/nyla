...
#define XCB_PRESENT_REDIRECT_NOTIFY 3
     ...
     *
     */
    xcb_present_query_version_cookie_t xcb_present_query_version(xcb_connection_t *c, uint32_t major_version,
                                                                 uint32_t minor_version);
     ...
     */
    xcb_present_query_version_cookie_t xcb_present_query_version_unchecked(xcb_connection_t *c, uint32_t major_version,
                                                                           uint32_t minor_version);
    ...
    xcb_present_query_version_reply_t *xcb_present_query_version_reply(
        xcb_connection_t *c, xcb_present_query_version_cookie_t cookie /**< */, xcb_generic_error_t **e);
     ...
     */
    xcb_void_cookie_t xcb_present_pixmap_checked(xcb_connection_t *c, xcb_window_t window, xcb_pixmap_t pixmap,
    ...
    xcb_void_cookie_t xcb_present_pixmap(xcb_connection_t *c, xcb_window_t window, xcb_pixmap_t pixmap, uint32_t serial,
                                         xcb_xfixes_region_t valid, xcb_xfixes_region_t update, int16_t x_off,
                                         int16_t y_off, xcb_randr_crtc_t target_crtc, xcb_sync_fence_t wait_fence,
    ...
    xcb_present_notify_t *xcb_present_pixmap_notifies(const xcb_present_pixmap_request_t *R);
     ...
     * saved for handling by xcb_request_check().
     */
    xcb_void_cookie_t xcb_present_notify_msc_checked(xcb_connection_t *c, xcb_window_t window, uint32_t serial,
     ...
     *
     */
    xcb_void_cookie_t xcb_present_notify_msc(xcb_connection_t *c, xcb_window_t window, uint32_t serial,
                                             uint64_t target_msc, uint64_t divisor, uint64_t remainder);
    ...
    xcb_present_query_capabilities_reply_t *xcb_present_query_capabilities_reply(
        xcb_connection_t *c, xcb_present_query_capabilities_cookie_t cookie /**< */, xcb_generic_error_t **e);

    int xcb_present_pixmap_synced_sizeof(const void *_buffer, uint32_t notifies_len);
     ...
     * saved for handling by xcb_request_check().
     */
    xcb_void_cookie_t xcb_present_pixmap_synced_checked(
        xcb_connection_t *c, xcb_window_t window, xcb_pixmap_t pixmap, uint32_t serial, xcb_xfixes_region_t valid,
        xcb_xfixes_region_t update, int16_t x_off, int16_t y_off, xcb_randr_crtc_t target_crtc,
     ...
     *
     */
    xcb_void_cookie_t xcb_present_pixmap_synced(xcb_connection_t *c, xcb_window_t window, xcb_pixmap_t pixmap,
                                                uint32_t serial, xcb_xfixes_region_t valid, xcb_xfixes_region_t update,
                                                int16_t x_off, int16_t y_off, xcb_randr_crtc_t target_crtc,
                                                xcb_dri3_syncobj_t acquire_syncobj, xcb_dri3_syncobj_t release_syncobj,
                                                uint64_t acquire_point, uint64_t release_point, uint32_t options,
                                                uint64_t target_msc, uint64_t divisor, uint64_t remainder,
                                                uint32_t notifies_len, const xcb_present_notify_t *notifies);

    xcb_present_notify_t *xcb_present_pixmap_synced_notifies(const xcb_present_pixmap_synced_request_t *R);

    int xcb_present_pixmap_synced_notifies_length(const xcb_present_pixmap_synced_request_t *R);
    ...
    xcb_present_notify_t *xcb_present_redirect_notify_notifies(const xcb_present_redirect_notify_event_t *R);
