...
#define XCB_XEVIE_SELECT_INPUT 4
     ...
     *
     */
    xcb_xevie_query_version_cookie_t xcb_xevie_query_version(xcb_connection_t *c, uint16_t client_major_version,
                                                             uint16_t client_minor_version);
     ...
     * The returned value must be freed by the caller using free().
     */
    xcb_xevie_end_reply_t *xcb_xevie_end_reply(xcb_connection_t *c, xcb_xevie_end_cookie_t cookie /**< */,
                                               xcb_generic_error_t **e);
     ...
     * The returned value must be freed by the caller using free().
     */
    xcb_xevie_send_reply_t *xcb_xevie_send_reply(xcb_connection_t *c, xcb_xevie_send_cookie_t cookie /**< */,
                                                 xcb_generic_error_t **e);
